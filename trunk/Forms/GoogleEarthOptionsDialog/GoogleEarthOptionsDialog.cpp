...
int MainWindow::doGoogleEarthOptionsDialog()
{
    ...
    if ( di.exists() == false )
        gs_FilenameGoogleEarth = getDocumentDir() + "/" + fi.baseName() + ".kml";

    GoogleEarthOptionsDialog dialog( this );

    dialog.GoogleEarthFilename_lineEdit->setText( QDir::toNativeSeparators( gs_FilenameGoogleEarth ) );
    ...
    dialog.StartGoogleEarth_checkBox->setChecked( gb_startGoogleEarth );
    dialog.GoogleEarthProgram_lineEdit->setText( QDir::toNativeSeparators( gs_FilenameGoogleEarthProgram ) );
...
// ******************************************************************************************************
    ...
    case QDialog::Accepted:
        gs_FilenameGoogleEarthProgram = dialog.GoogleEarthProgram_lineEdit->text();
        gs_FilenameGoogleEarth        = dialog.GoogleEarthFilename_lineEdit->text();
